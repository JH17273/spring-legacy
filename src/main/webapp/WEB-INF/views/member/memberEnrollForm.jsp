			...
			<table align="center">
				<tr>
					...
					<td><form:input path="userId" required="required" />
						<button type="button" onclick="idCheck();">아이디중복체크</button> <form:errors
							path="userId" cssClass="error" /></td>
				</tr>
				<tr>
					<td>* PWD</td>
					<td><form:password path="userPwd" required="required" /> <form:errors
							path="userPwd" cssClass="error" /></td>
				</tr>
				<tr>
					<td>* NAME</td>
				...
				<tr>
					<td>&nbsp;&nbsp;BIRTHDAY</td>
					<td><form:input path="birthday" placeholder="생년월일(6자리)" /> <form:errors
							path="birthday" cssClass="error" /></td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;GENDER</td>
					<td align="center"><form:radiobutton path="gender" value="M" />
						남 <form:radiobutton path="gender" value="F" /> 여 <form:errors
							path="gender" cssClass="error" /></td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;PHONE</td>
					<td><form:input path="phone" placeholder="-포함" /> <form:errors
